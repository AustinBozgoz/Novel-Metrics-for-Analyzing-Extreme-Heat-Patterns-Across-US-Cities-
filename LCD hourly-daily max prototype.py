...
def progress_controller(checkpoint='checkpoint.csv',update=False,city=None): #manages the checkpoint file and returns entries needed to operate the LCD file program
...
while stop==0:#never actually triggers
    currentCity,currentDir,currentStation,fileNames,startYears,endYears=progress_controller(update=update,city=city)#pull all variables needed to analyze this city
